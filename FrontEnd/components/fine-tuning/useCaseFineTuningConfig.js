...
const useCaseConfigs = {
  ...
  "class-wise-object-counting": {
    ...
    baseModels: [
      { value: "count-fast", label: "Counting Fast", tradeoff: "Faster", helper: "Good when lighter detector tuning matters more than class detail." },
      { value: "count-balanced", label: "Counting Balanced", tradeoff: "Recommended", helper: "Balanced default to improve detection quality for counting in most roads and logistics yards." },
      { value: "count-accurate", label: "Counting Accurate", tradeoff: "Highest accuracy", helper: "Use when stronger class separation and better detections are the priority." },
    ],
  ...
  "object-tracking": {
    ...
    baseModels: [
      { value: "track-fast", label: "Detector Fast", tradeoff: "Faster", helper: "Quicker detector tuning for tracked people and vehicles." },
      { value: "track-balanced", label: "Detector Balanced", tradeoff: "Recommended", helper: "Good detector starting point for most object tracking scenes." },
      { value: "track-identity", label: "Detector Quality Focus", tradeoff: "Highest accuracy", helper: "Better person and vehicle detections improve downstream tracking." },
    ],
