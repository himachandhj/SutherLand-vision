...
export const useCases = [
  ...
  },
  {
    ...
    cardSummary: "Detect cracks and surface defects for inspection workflows.",
    cardAvailableVerticals: ["Roads", "Walls", "Floors"],
    cardExtendableVerticals: ["Bridges", "Potholes", "Corrosion", "Leakage detection"],
    description: "Detects cracks or surface defects on roads, walls, floors, bridges, and construction structures to help inspection teams identify damaged areas faster.",
    currentDescription: "Detects cracks or surface defects on roads, walls, floors, bridges, and construction structures to help inspection teams identify damaged areas faster.",
